//! Flash messages and authorization policies.
//!
//! The authentication extractors moved to [`crate::auth::extract`] and the
//! session API to [`crate::auth::session_api`]; both are re-exported here so
//! the `auth::dx` paths keep resolving.
//!
//! # Extractors
//!
